...
customer1 = {
    "company_name": "Angelina Inc",
    "contact_person": "Angelina Smith",
    "email": "angelina@angelina.com",
    "phone": "813-155-9862"
}

customer2 = {
    "company_name": "Varang Solutions",
    "contact_person": "John Doe",
    "email": "contact@varang.com",
    "phone": "813-876-4590"
}

customer3 = {
    "company_name": "Quarritch Technologies",
    "contact_person": "Juan Cortez",
    "email": "juan@quarritch.com",
    "phone": "813-313-9991"
}

customer4 = {
    "company_name": "White Monster Media",
    "contact_person": "Sarah Williams",
    "email": "sarah@whitemonster.com",
    "phone": "813-420-2827"
}
...
print(f"\nCustomer C002 Information: {c002_info}")

c003_contact = customers ["C003"]["contact_person"]
print(f"\nCustomer C003 Contact Person: {c003_contact}")

c999_info = customers.get("C999", "Customer C999 not found.")
print(f"\nCustomer C999 Information: {c999_info}")
...
customers["C001"]["phone"] = "813-555-0000"
...
print("-" * 60)
# Add your code here
project1 = {"name": "Company Website", "service": "Web Development", "hours": 120, "budget": 18000}
project2 = {"name": "Data Dashboard", "service": "Data Analysis", "hours": 80, "budget": 14000}
project3 = {"name": "Security Assessment", "service": "SOC Analyst", "hours": 150, "budget": 30000}
project4 = {"name": "Cloud Setup", "service": "Cloud Support", "hours": 90, "budget": 11000}
project5 = {"name": "IT Support Setup", "service": "Help Desk", "hours": 60, "budget": 6000}

projects = {
    "C001": [project1, project5],
    "C002": [project2],
    "C003": [project3, project4],
    "C004": [project1, project2, project3, project4, project5]
}
...
for project_list in projects.values():
    for project in project_list:
        ...
        if project["budget"] > max_budget:
            max_budget = project["budget"]
        
        if project["budget"] < min_budget:
            min_budget = project["budget"]

avg_budget = total_budget / project_count
...
print("-" * 60)
# Add your code here
active_customers = {cid: customers[cid] for cid in customers if cid in projects and projects[cid]}
...
print("-" * 60)
# Add your code here
customer_budgets = {cid: sum(project["budget"] for project in proj_list)
...
for cid, customer_info in customers.items():
    is_valid = validate_customer(customer_info)
    print(f"{cid}: {is_valid}")
...
def recommend_services(customer_id, customers, projects, services):
    ...
    avg_budget = total_budget / len(customer_projects)
    ...
    for service, rate in services.items():
        if service not in used_services:
            ...
            elif avg_budget >= 10000 and rate <= 175:
                recommendations.append(service)
            elif avg_budget < 10000 and rate <= 120:
                recommendations.append(service)
